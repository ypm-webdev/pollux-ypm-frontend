...
export const Three: React.FC<ThreeProps> = ({
  ...
  const glbFiles = [
    [
      {
        uri: 'ypmvppu.014554.i_antrodemus_valens_manual_ungual.glb',
        label: 'Manual Ungual',
      },
      {
        uri: 'ypm_vppu.014554.j_antrodemus_valens_pedal_ungual.glb',
        label: 'Pedal Ungual',
      },
    ],
    [
      {
        uri: 'ypm_pb.053910a_pecopteris_miltoni_fossil_leaf.glb',
        label: 'Fossil Leaf A',
      },
      {
        uri: 'ypm_pb.053910b_pecopteris_miltoni_fossil_leaf.glb',
        label: 'Fossil Leaf B',
      },
    ],
    ...
    [
      ...
      {
        uri: 'ypm_bc.006943_nbc_03968_virtual_impression.glb',
        label: 'Virtual Impression',
      },
    ],
    [
      {
        uri: 'ypm_ent.619345_scarab_chrysina_gloriosa.glb',
        label: 'Chrysina Gloriosa',
      },
    ],
    [
      {
        uri: 'ypm_ent.626825_orthoptera_melanoplus_spretus.glb',
        label: 'Melanoplus Spretus',
      },
    ],
  ]
  ...
  const handleZoom = (direction: 'in' | 'out'): void => {
    ...
    const targetPosition = center
      .clone()
      .add(direction3d.multiplyScalar(newDistance))
  ...
  const handleResetZoom = (): void => {
    ...
    const targetPosition = center
      .clone()
      .add(direction3d.multiplyScalar(distance))
  ...
  const createGradientBackground = (isDark: boolean): THREE.Color => {
  ...
  const initViewer = (
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        const cameraZ = Math.abs(scaledMaxDim / 2 / Math.tan(fov / 2))
    ...
    const animate = (): void => {
      ...
      if (
        ...
        if (
          Math.abs(currentDistance - initialCameraDistanceRef.current) >
          tolerance
        ) {
      ...
      <Col className="three-container d-flex px-0">
        <article>
          ...
          {currentSetIndex !== undefined &&
            glbFiles[currentSetIndex] &&
            glbFiles[currentSetIndex].length > 1 && (
              <div
                style={{
                  width: '100%',
                  marginTop: '1rem',
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            lineHeight: '1.2em',
                            fontWeight:
                              index === currentFileIndex ? '700' : '400',
                          }}
                        >
                          {file.label}
                        </div>
